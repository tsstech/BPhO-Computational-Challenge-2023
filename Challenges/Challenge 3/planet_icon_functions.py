...
sunOrbitPen = turtle.Turtle()
mercuryOrbitPen = turtle.Turtle()
venusOrbitPen = turtle.Turtle()
earthOrbitPen = turtle.Turtle()
marsOrbitPen = turtle.Turtle()
jupiterOrbitPen = turtle.Turtle()
saturnOrbitPen = turtle.Turtle()
uranusOrbitPen = turtle.Turtle()
neptuneOrbitPen = turtle.Turtle()
